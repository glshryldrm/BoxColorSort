...
namespace HomaGames.HomaBelly
{
    public class AdjustAttributionAdapter : IAttributionWithInitializationCallback
    {
        ...
        private void TrackEvent(string eventName, Dictionary<string, object> callbackParameters, Dictionary<string, object> partnerParameters)
        {
        ...
        public void TrackEventWithPartnerParameters(string eventName, Dictionary<string, object> partnerParameters, Dictionary<string, object> arguments = null)
        {
