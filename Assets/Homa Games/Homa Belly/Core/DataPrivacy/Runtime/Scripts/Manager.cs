...
namespace HomaGames.HomaBelly.DataPrivacy
{
    ...
    public sealed class Manager
    {
        ...
        public static bool IsGdprProtectedRegion => !UserCentricsApiWrapper.InitializationFailed && UserCentricsApiWrapper.ShouldCollectConsent;
...
#pragma warning restore CS0618
            await UserCentricsApiWrapper.ShowConsentMenuAndAttAsync();
