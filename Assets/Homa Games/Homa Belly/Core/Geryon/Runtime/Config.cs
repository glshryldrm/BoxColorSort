...
namespace HomaGames.Geryon
{
    ...
    public static class Config
    {
        ...
        public static DvrDatabase DvrDatabase { get; } = new DvrDatabase();
        ...
        internal static Task OnGameLaunch()
        {
            ...
            if (! RemoteConfiguration.FirstTimeConfigurationNeededThisSession())
                ...
                LoadingFirstTimeValuesFromPersistence = Task.WhenAll(                
                    ...
                    .ContinueWith(task => DvrDatabase.Update(task.Result)));
            
            return Task.CompletedTask;
        }

        internal static async Task OnFirstTimeConfigurationFetched()
        {
            ...
            try
            {
                ...
                if (firstTimeGeryonConfigurationModel != null)
                {
                    if (firstTimeGeryonConfigurationModel.IsStatusOk())
                    {
                        ...
                        DvrDatabase.Update(firstTimeGeryonConfigurationModel.Configuration);
        ...
        internal static async Task OnEveryTimeConfigurationFetched()
        {
            if (RemoteConfiguration.FirstTimeConfigurationNeededThisSession())
            {
            ...
            try
            {
                ...
                if (everyTimeGeryonConfigurationModel != null)
                {
                    if (everyTimeGeryonConfigurationModel.IsStatusOk())
                    {
                        ...
                        DvrDatabase.Update(everyTimeGeryonConfigurationModel.Configuration);
                    }
